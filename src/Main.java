...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (option != 7) {
            ...
            try {
                ...
                switch (option) {
                    case 1:
                        countNucleotidesMenu(sequence);
                        break;
                    case 2:
                        ReverseNucleotidesMenu(sequence);
                        break;
                    case 3:
                        Transcribing2RNAMenu(sequence);
                        break;
                    case 4:
                        TranslateRNAMenu(sequence);
                        break;
                    case 5:
                        InferringModuloARNMenu(scanner, sequence);
                        break;
                    case 6:
                        sequence = AddNewSequenceMenu(scanner);
                        break;
                    case 7:
                        exit(0);
                    default:
    ...
    private static void InferringModuloARNMenu(Scanner scanner, String sequence) throws Exception {
